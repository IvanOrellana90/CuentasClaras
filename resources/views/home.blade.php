            ...
            <div class="row bg-white has-shadow">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        <div class="icon bg-red"><i class="icon-user marginTop5"></i></div>
                        <div class="title"><span>Deudas<br>Pendientes</span>
                            <div class="progress">  
                            @if($user->debts->count() != 0)
                                <div role="progressbar" style="width: {{ ($user->debts->where('state',0)->count()/$user->debts->count())*100 }}% height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                            @else
                                <div role="progressbar" style="width: 0% height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
                            @endif
                            </div>
                        </div>
                        <div class="number"><strong>{{ $user->debts->where('state',0)->count() }}</strong></div>
                    </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        <div class="icon bg-violet"><i class="icon-padnote marginTop5"></i></div>
                        <div class="title"><span>Grupos<br>Creados</span>
                            <div class="progress">
                                <div role="progressbar" style="width: 70%; height: 4px;" aria-valuenow="{#val.value}" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-violet"></div>
                            </div>
                        </div>
                        <div class="number"><strong>{{ $user->groups->count() }}</strong></div>
                    </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        <div class="icon bg-green"><i class="icon-bill marginTop5"></i></div>
                        <div class="title"><span>Tickets<br>Pendientes</span>
                            <div class="progress">
                        ...
                        <div class="number"><strong>{{ $user->tickets->where('active',1)->count() }}</strong></div>
                    </div>
                </div>
                <!-- Item -->
                <div class="col-xl-3 col-sm-6">
                    <div class="item d-flex align-items-center">
                        <div class="icon bg-orange"><i class="icon-check marginTop5"></i></div>
            ...
            <div class="row">
                ...
                <div class="statistics col-lg-3 col-12">
                    <div class="statistic d-flex align-items-center bg-white has-shadow">
                        ...
                        <div class="text"><strong>{{ gastosPromedio() }}</strong><br><small>Gastos Mensuales</small></div>
                    </div>
                    <div class="statistic d-flex align-items-center bg-white has-shadow">
                    ...
                    <div class="statistic d-flex align-items-center bg-white has-shadow">
                        ...
                        <div class="text"><strong>{{ gastosEsteMes() }}</strong><br><small>Gastos este mes</small></div>
                    </div>
                </div>
                <!-- Line Chart            -->
...
@section('js')
    ...
    <script src="{{ URL::to('dist/js/charts-home.js') }}"></script>
    @include('includes.jquery-home')
@endsection